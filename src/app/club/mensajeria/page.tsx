...
export default function ClubMensajeria() {
  return (
    <div className="flex flex-col gap-6 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      <div className="border-b pb-4 flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500 text-xs mt-0.5">Comunicaciones formales y reclamos con la administración LFS.</p>
        </div>
      ...
      <div className="bg-white border border-slate-200 rounded-2xl p-8 text-center text-slate-400 flex flex-col items-center gap-2 shadow-sm">
        ...
        <p className="text-xs text-slate-500 max-w-sm">No has recibido mensajes de la administración hoy. Las notificaciones de sanciones se envían por este medio.</p>
      </div>
    </div>
  );
}
