...
export default function ClubGlobalCatchAll() {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl mx-auto mt-12 text-center items-center p-4">
      ...
      <div>
        <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Módulo del Club - Redirección</span>
        ...
        <p className="text-slate-500 text-xs mt-2 max-w-md mx-auto">
          Esta sección se encuentra enlazada y configurada en el panel del club. Serás redirigido al módulo principal correspondiente para continuar con las operaciones.
        </p>
      </div>
